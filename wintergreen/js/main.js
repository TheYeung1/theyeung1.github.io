...
$(document).ready(function(){
  ...
  $("#turnt-yes").click(function(){
    ...
    $("#liljon").append("<iframe id=\"liljonvid\" width=\"0\" height=\"0\" style=\"visibility: hidden\" src=\"http:\/\/www.youtube.com\/embed\/CsyAagzMuUo?rel=0&autoplay=1&cc_load_policy=1&t=17s&enablejsapi=1\" frameborder=\"0\" allowfullscreen><\/iframe>");
    ...
    $("#liljonvid").css("width", "0%");
    $("#liljonvid").css("height", "0%");
    window.setInterval(function(){
      $("#countdown-days")
